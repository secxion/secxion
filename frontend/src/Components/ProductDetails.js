          ...
          (
            <div className="gap-1 flex flex-col">
              ...
              <div className="grid items-center gap-3 my-2">
                <button className="border-2 border-emerald-900 px-3 py-1 min-w-[120px] font-medium hover:bg-yellow-600" onClick={(e) => handleSell(e, data?._id)}>Sell</button>
                <button className="border-2 border-yellow-600 text-white px-3 py-1 min-w-[120px] bg-emerald-700" onClick={(e) => handleAddToCart(e, data?._id)}>Add to Catalog</button>
              </div>
